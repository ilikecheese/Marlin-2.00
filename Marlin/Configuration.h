...
#define CUSTOM_MACHINE_NAME "Eide V2.0"
...
#define TEMP_RESIDENCY_TIME      5  //10  // (seconds) Time to wait for hotend to "settle" in M109
...
#define HEATER_0_MAXTEMP 280 //275
#define HEATER_1_MAXTEMP 280 //275
#define HEATER_2_MAXTEMP 280 //275
#define HEATER_3_MAXTEMP 280 //275
#define HEATER_4_MAXTEMP 280 //275
#define HEATER_5_MAXTEMP 280 //275
...
#define EXTRUDE_MINTEMP 170 //175
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 160 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 9000 } //{ 4000, 4000, 4000, 4000 }
 ...
 */
#define DEFAULT_ACCELERATION          6000 //2500    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  6000 //3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   6000 //3000    // X, Y, Z acceleration for travel (non printing) moves
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 17.0 //35.00
...
#define DEFAULT_EJERK    17.0  // May be used by Linear Advance
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM .042 //0.016 // (mm) Distance from real junction edge
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.0, 22.0, -0.35} //0,25,-.38
...
#define Z_PROBE_SPEED_FAST XY_PROBE_SPEED //(HOMING_FEEDRATE_Z / 2)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    5 //50 // Z Clearance for Deploy/Stow
...
#define INVERT_E3_DIR true //false
#define INVERT_E4_DIR true //false
#define INVERT_E5_DIR true //false
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      00    // (°C) Default bed temperature for the G26 Mesh Validation Tool.
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 2.5     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
